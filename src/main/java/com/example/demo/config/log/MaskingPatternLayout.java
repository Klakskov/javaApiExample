...
public class MaskingPatternLayout extends PatternLayout {
    ...
    private String patternsProperty = RemoveFromLog.getPatternRemove();
    ...
    public void setPatternsProperty() {
        this.patternsProperty = RemoveFromLog.getPatternRemove();
        if (this.patternsProperty != null) {
            this.pattern = Optional.of(Pattern.compile( this.patternsProperty,
